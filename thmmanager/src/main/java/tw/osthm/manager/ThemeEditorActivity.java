...
public class ThemeEditorActivity extends AppCompatActivity implements ColorPickerDialogListener {
    ...
    public static int ACCENT_COLOR = -9673729;
        ...
        image_saveb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!til1.getText().toString().equals("") && !til2.getText().toString().equals("") && !til3
                    ...
                    try {
                        if (getIntent().getBooleanExtra("isEditing", false)) {
                            osthmEngine.editTheme(sp.getInt("colorPrimary", -13749191),
                                    sp.getInt("colorPrimaryText", -1), sp.getInt("colorPrimaryDark", -13749191),
                                    sp.getInt("colorStatusbarTint", 1), sp.getInt("colorBackground", -14473430),
                                    sp.getInt("colorBackgroundText", -1), sp.getInt("colorAccent", -9270822),
                                    sp.getInt("colorAccentText", -1), sp.getInt("shadow", 1),
                                    sp.getInt("colorControlHighlight", 1073741824), sp.getInt("colorHint", -5723992),
                                    sp.getInt("colorPrimaryTint", -1), sp.getInt("colorBackgroundTint", -14473430),
                                    ...
                                    sp.getInt("colorPrimaryCardTint", -14473430), sp.getInt("colorBackgroundCardTint", -14473430),
                                    sp.getInt("colorDialog", -14473430), sp.getInt("colorDialogText", -1), sp.getInt("colorDialogTint", -1),
                            ...
                            osthmEngine.addTheme(sp.getInt("colorPrimary", -13749191),
                                    sp.getInt("colorPrimaryText", -1), sp.getInt("colorPrimaryDark", -13749191),
                                    sp.getInt("colorStatusbarTint", 1), sp.getInt("colorBackground", -14473430),
                                    sp.getInt("colorBackgroundText", -1), sp.getInt("colorAccent", -9270822),
                                    sp.getInt("colorAccentText", -1), sp.getInt("shadow", 1),
                                    sp.getInt("colorControlHighlight", 1073741824), sp.getInt("colorHint", -5723992),
                                    sp.getInt("colorPrimaryTint", -1), sp.getInt("colorBackgroundTint", -7762803),
                                    sp.getInt("colorPrimaryCard", -1), sp.getInt("colorBackgroundCard", -1),
                                    sp.getInt("colorPrimaryCardText", -16777216), sp.getInt("colorBackgroundCardText", -16777216),
                                    sp.getInt("colorPrimaryCardTint", -14473430), sp.getInt("colorBackgroundCardTint", -14473430),
                                    sp.getInt("colorDialog", -14473430), sp.getInt("colorDialogText", -1), sp.getInt("colorDialogTint", -1),
